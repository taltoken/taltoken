...
export type StyledMailtoLinkProps = {
  email: string;
  children: React.ReactNode;
}
...
export const StyledMailto = ({ email, children }: StyledMailtoLinkProps) => {
  return (
    <a className={Styled.PageLink} target="_blank" href={`mailto:${email}`}
      onClick={(e) => {
